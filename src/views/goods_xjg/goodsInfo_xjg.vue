    ...
    <div class="app-container">
        ...
        <div class="filter-container">
            ...
            <el-table :data="list" border fit highlight-current-row ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <!-- <el-table-column prop="id" label="商品编号" sortable width="200"></el-table-column> -->
                <el-table-column prop="goodsName" label="商品名" sortable width="200"></el-table-column>
                <!-- <el-table-column prop="goodsType" label="商品类别" sortable width="200">
                    <template slot-scope="scope">
                        <span v-if="scope.row.goodsType == '1'">鞋子</span>
                        <span v-if="scope.row.goodsType == '2'">衣服</span>
                    </template>
                </el-table-column> -->
                <!-- <el-table-column prop="goodsType"></el-table-column> -->
                <el-table-column prop="goodsTypeValue" label="商品类别" sortable width="200"></el-table-column>
                <el-table-column prop="price" label="商品价格" sortable width="200"></el-table-column>
                  <!-- <el-table-column prop="saleFlg" label="商品状态" sortable width="200">
                    <template slot-scope="scope">
                        <span v-if="scope.row.saleFlg == '1'">上架</span>
                        <span v-if="scope.row.saleFlg == '0'">下架</span>
                    </template>
                </el-table-column> -->
                <!-- <el-table-column prop="saleFlg" ></el-table-column> -->
                <el-table-column prop="saleFlgValue" label="商品状态" sortable width="200"></el-table-column>
                <el-table-column prop="count" label="数量" sortable width="200"></el-table-column>
                <el-table-column prop="goodsId" align="center" label="操作" width="200" fixed="right">
                    <template slot-scope="scope">
                        <el-button v-if="scope.row.saleFlg" size="small" type="success" @click="updateGoods(scope.row)">修改</el-button>
