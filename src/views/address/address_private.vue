    ...
    <div class="app-container">
        <div class="filter-container">
            ...
            <el-table :data="list" border fit highlight-current-row>
                ...
                <el-table-column prop="privateFlg" align="center" label="移出我的通讯录" width="120">
                    <template slot-scope="scope">
                        <el-button v-if="scope.row.privateFlg==0" size="small" type="success" class="el-icon-plus" @click="">添加</el-button>
...
<script>
    import { paginationPrivate,moveFormPrivate} from '@/api/address'
    ...
    export default {
        ...
        methods: {
            ...
            fetchData() {
                ...
                paginationPrivate(this.listQuery).then(response => {
